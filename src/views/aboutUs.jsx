...
import { browser, appCont, home, my, shareLight, myActive} from '../static/static';
    		       ...
    		       <Grid style={styles.gridWrap}>
                          ...
                          <Col style={styles.col5}>
	                          <Link href="qap://aboutUs.js">
			                         <View>
			                              <Image source={{uri: myActive}}  style={styles.imgStyle}/>
			                         	  <Text style={[styles.textColor,{color:'#40aae1'}]}>联系我们</Text>
			                         </View>
	                    		</Link>
                          </Col>
                    </Grid>
