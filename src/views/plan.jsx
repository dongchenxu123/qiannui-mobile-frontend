...
import { browser, appContActive, home, my, shareLight } from '../static/static';
    		       ...
    		       <Grid style={styles.gridWrap}>
                          ...
                          <Col style={styles.col4}>
	                          <Link href="qap://plan.js">
		                         <View>
		                              <Image source={{uri: appContActive}}  style={styles.imgStyle}/>
		                         	  <Text style={[styles.textColor,{color:'#40aae1'}]}>计划</Text>
		                         </View>
                    		</Link>
                          </Col>
